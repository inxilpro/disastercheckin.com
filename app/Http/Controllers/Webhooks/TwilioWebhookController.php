    ...
    public function __invoke(Request $request)
    {
        ...
        try {
            return $this->toResponse(match ($command->command) {
                ...
                default => 'To share a public update on the disaster check-in site to anyone who knows your phone number, start your message with "UPDATE" (eg. UPDATE I am doing OK!)',
            });
