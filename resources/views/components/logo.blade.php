<h1 class="text-3xl font-bold w-full mb-8">
    <a class="flex items-center gap-3 no-underline text-slate-600 tracking-tight" href="/">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="fill-red-500" style="width: 2.5rem; height: 2.5rem;">
            <path
